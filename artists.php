...
$result4 = dispaly_artists();


if (isset($_GET['delete'])) {
    $deleteartistID = $_GET['delete'];
    delete_artist($deleteartistID); // Assuming you have a function to delete the song in your functions.php
    header("Location: artists.php"); // Redirect back to the same page after deletion
}

// Check if a search term is provided in the URL
if (isset($_GET['search'])) {
    $searchTerm = $_GET['search'];
    $result4 = search_artists($searchTerm);
}
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="artists.php">Artists</a>
						</li>
					</ul>
				</div>
			</div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="?delete=<?php echo $ArtistID; ?>" class="btn btn-danger">Delete</a></td>
                                                    </tr> 
                                            <?php 
                                                    }  
                                            ?>                                                                  
