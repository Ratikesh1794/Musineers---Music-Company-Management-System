...
$result2 = dispaly_songs();

if (isset($_GET['delete'])) {
    $deleteSongID = $_GET['delete'];
    delete_song($deleteSongID); // Assuming you have a function to delete the song in your functions.php
    header("Location: songs.php"); // Redirect back to the same page after deletion
}

if (isset($_GET['search'])) {
    $searchTerm = $_GET['search'];
    $result2 = search_songs($searchTerm);
}
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="songs.php">Songs</a>
						</li>
					</ul>
				</div>
			</div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="?delete=<?php echo $SongID; ?>" class="btn btn-danger">Delete</a></td>
                                                    </tr>        
                                            <?php 
                                                    }  
                                            ?>                                                                    
